...
notis.new("<Color=White>DK-HUB<Color=/>"):Display()
notis.new("<Color=Blue>Founder: TRẦN DUY KHA<Color=/>"):Display() 
notis.new("<Color=Red>Discord: Link Discord<Color=/>"):Display() 
...
local OrionLib = loadstring(game:HttpGet(("https://raw.githubusercontent.com/duykha-beep/DuykhaHub/refs/heads/main/1.lua")))()
